<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditoriaCliente.aspx.cs" Inherits="AppDCASeparacao.AuditoriaCliente" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <title>Auditoria Clientes</title>
</head>
<body>
    <form id="form1" runat="server"> 
        <div class="pb-2 mt-4 mb-2 border-bottom container">
		    <h4>Lista de clientes na classe B e C dos últimos 5 dias </h4> 
        </div>
         <div class="row">            
